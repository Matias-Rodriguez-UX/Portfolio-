const dataProjectsEs = [
    {
        ...
        description: "Diseñar y desarrollar una página para club de vinos que incluía: autenticación, búsquedas, filtrados combinados, ordenamientos, baneo de usuarios, envío de emails, etc, creación de membresías, reviews, wishlist, protección de rutas, etc",
        whatIdo: "Estuve a cargo del desarrollo visual de la pagina, el ananlisis del comportamiento del usuario, los elementos visuales, su coherencia y cohesión, la pagina de inicio y el perfil del administrador con su dashboard",
    ...
    },
    {
        id: 2,
        name: "Alura",
        description: "Curso práctico donde se desarrollaron proyectos responsivos, y se controlaba el comportamiento de los elementos HTML desde el DOM",
        whatIdo: "Se desarrollaron integralmente los comportamientos y el renderizado de los mismo en los diferentes proyectos",
    ...
    },
    {
        id: 3,
        name: "Pokemon",
        description: "Proyecto Individual de Henry donde se trabajo con APIs, databases, react, redux, etc.",
        whatIdo: "Diseñar y desarrollar una App de pokemons que incluía: búsquedas, filtrados combinados,ordenamientos, creación y edición de pokemones",
    ...
    },
    {
        ...
        whatIdo: "Se realizó el ananlisis del comportamiento del usuario, los elementos visuales, su coherencia y cohesión, la pagina de inicio y la historia de la institución",
    ...
    },
    {
        id: 5,
        name: "Dewey",
        description: "Aplicación para reserva de turno para actividades extracurriculares de niños",
        whatIdo: "Desarrollo completo de diseño UX/UI para toda la aplicación, donde se utilizó ux research, generación de ui components, ilustraciones, story boards, wire frames, etc.",
    ...
    },
    {
        ...
        whatIdo: "Rediseño de todas las líneas de producción y actualización de la estética de telas, estampados y combinaciones. Desarrollo de nuevos productos e implementación de nuevas tecnologías",
    ...
    },
    {
        ...
        whatIdo: "Creación de Marca, diseño de banners, publicaciones y reels para redes sociales",
    ...
    },
    {
        id: 8,
        name: "Nomade",
        description: "Tesis universitaria: Sistema de traslado de personas en emergencia en terrenos arenosos",
        whatIdo: "Creación, desarrollo y realización de prototipo del producto, junto con sus piezas gráficas y sus planos técnicos productivos",
