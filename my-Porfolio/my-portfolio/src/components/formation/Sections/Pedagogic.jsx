...
export default function Pedagogic() {
    ...
    return (
        <section className="container formation-system-section">
            ...
            <img src="https://res.cloudinary.com/dcbax1feo/image/upload/v1679245879/assets/logo-v_qlnhvv.png" alt={t("spe.institution")} loading="lazy" decoding="async" style={{ width: '96px', height: 'auto' }} />
        </section>
    )
}