...
export default function University() {
    ...
    return (
        <section className="container formation-system-section">
            ...
            <img src="https://res.cloudinary.com/dcbax1feo/image/upload/v1679245239/assets/UNLP-e1667509972531-removebg-preview_ono0mo.png" alt={t("university.institution")} loading="lazy" decoding="async" style={{ width: '201px', height: 'auto' }} />
        </section>
    )
}