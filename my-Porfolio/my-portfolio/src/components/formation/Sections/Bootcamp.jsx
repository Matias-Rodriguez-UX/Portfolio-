    ...
    return (
        <section className="container formation-system-section">
            ...
            <a href='https://certificates.soyhenry.com/new-cert?id=01907b43009fbf36a1c8f538822925e1f34e4afe9529ffd2b0e08454eb190d21' target="_blank" rel="noreferrer">
                <img src="https://res.cloudinary.com/dcbax1feo/image/upload/v1679244618/assets/titulo_henry_bpsbbe.png" alt={t("a11y.certImage", { title: t("bootcamp.title") })} loading="lazy" decoding="async" style={{ height: '110px', width: 'auto' }} />
            </a>
        </section>
    )
}