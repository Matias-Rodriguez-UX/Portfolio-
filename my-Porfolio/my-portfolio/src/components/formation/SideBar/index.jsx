  ...
  function NavbarLink({ to, children }) {
    return (
      <Nav.Link
        ...
        to={to}
        className={
          location.hash === to || currentPage === to.replace("#", "")
            ? "nav-link active new-class-Nav-A"
            : "nav-link inactive new-class-Nav-I"
        }
      >
        {children}
      </Nav.Link>
  ...
  return (
    <>
      <Nav variant="pills" className="nav-display">
        ...
        >
          <NavbarLink to="#fullstack">
            <svg
              ...
              height="16"
              fill="currentColor"
              className="bi bi-pc-display me-4"
              viewBox="0 0 16 16"
            >
        ...
        <Nav.Item
          onClick={() => setCurrentPage("highschool")}
          className="nav-item-display"
        >
        ...
        <Nav.Item
          onClick={() => setCurrentPage("pedagogic")}
          className="nav-item-display"
        >
